...
__CHEETAH_genTime__ = 1528717961.265576
__CHEETAH_genTimestamp__ = 'Mon Jun 11 14:52:41 2018'
__CHEETAH_src__ = 'books_by_author.tmpl'
__CHEETAH_srcLastModified__ = 'Mon Jun 11 14:52:27 2018'
...
''')
                for column in VFFSL(SL,"columns",True): # generated from line 36, col 3
                    write(u'''  <td>''')
                    _v = VFN(VFFSL(SL,"cgi",True),"escape",False)(unicode(VFFSL(SL,"getattr",False)(VFFSL(SL,"book",True), VFFSL(SL,"column",True)) or '')) # u"$cgi.escape(unicode($getattr($book, $column) or ''))" on line 37, col 7
                    if _v is not None: write(_filter(_v, rawExpr=u"$cgi.escape(unicode($getattr($book, $column) or ''))")) # from line 37, col 7.
                    write(u'''</td>
''')
                write(u'''  </tr>
''')
            write(u'''  <tr>
  <td colspan="''')
            _v = VFFSL(SL,"columns1",True) # u'$columns1' on line 42, col 16
            if _v is not None: write(_filter(_v, rawExpr=u'$columns1')) # from line 42, col 16.
